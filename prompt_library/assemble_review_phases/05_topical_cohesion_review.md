...
- `3_article_outputs/stage_4_terminology_introduction_draft.md`;
- all working ledgers;
...
Save the revised manuscript as `3_article_outputs/stage_5_topical_cohesion_draft.md`. Record the
...
- checksums for `stage_4_terminology_introduction_draft.md` and `stage_5_topical_cohesion_draft.md`.
