...
Review `COHESION_DRAFT.md` against every weighted rubric criterion. Evaluate:
...
After `FINAL_DRAFT.md` is complete, overwrite
`2-outputs/audits_and_synthetic_reviews/reviewer_notes.md` with a mock
...
Finally, compare checksums for `COHESION_DRAFT.md`, `THIRD_DRAFT.md`, and
`FINAL_DRAFT.md`, explain any identical stages in the run-state ledger, and
