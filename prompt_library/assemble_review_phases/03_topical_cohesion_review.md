...
For each, record in `reviewer_notes.md`:
...
Save the revised manuscript as `2-outputs/COHESION_DRAFT.md`. Append
`# Topical Cohesion Review` to
`2-outputs/audits_and_synthetic_reviews/reviewer_notes.md`, including:
...
- checksums for `SECOND_DRAFT.md` and `COHESION_DRAFT.md`.
...
document why; do not claim that a revision occurred.
