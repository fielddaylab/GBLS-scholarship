...
- Outline and word targets: `0-human-sources/outline_structure.md`
- Authorial commitments: `0-human-sources/explicit_values.md`
- Approved process account: `0-human-sources/process.md`
...
Read the full coded summaries most relevant to the section, including their metadata, evidence limits, suggested contributions, and exclusions. Search the complete summary corpus for the section's headings, service areas, game formats, outcomes, design principles, and named debates. Do not rely only on preexisting draft prose.
